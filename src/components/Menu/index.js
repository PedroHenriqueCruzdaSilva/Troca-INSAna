...
9 14 0 25 4 25 9 0 13 -33 19 -58 10z" fill="rgb(0, 74, 173)"
        />
        <path
          d="M1060 195 c0 -51 3 -65 15 -65 12 0 15 14 15 65 0 51 -3 65 -15 65
-12 0 -15 -14 -15 -65z" fill="rgb(0, 74, 173)"
        />
        <path
...
l-3 -48 -28 48 c-18 30 -35 47 -47 47 -18 0 -20 -7 -20 -65z" fill="rgb(0, 74, 173)"
        />
        <path
...
29 24 20 24 -13z" fill="rgb(0, 74, 173)"
        />
        <path className="pathB"
